...
df
#BT2: Trích xu???t d??? li???u t??? tr???m 1. Có bao nhiêu quan sát ðý???c t???i tr???m này? Ð??? sâu l???y m???u t???i thi???u, trung v???, trung b??nh và t???i ða t???i tr???m 1 là bao nhiêu?
#Xác ð???nh xem tr???m nào có ít quan sát hõn ðáng k???. T???o m???t khung d??? li???u m???i b??? qua các tr???m này.
#Trích xu???t d??? li???u t??? nãm 2002. Trích xu???t d??? li???u t??? tháng 4. Trích xu???t d??? li???u ðý???c ðo ??? ð??? sâu l???n hõn 2000 mét. Hi???n th??? d??? li???u theo giá tr??? ð??? sâu tãng d???n. Hi???n th??? d??? li???u ðý???c ðo ??? ð??? sâu hõn 2000 mét vào tháng Tý.
ISIT <- read_excel("C:/Users/LENOVO/Downloads/ISIT.xls")
View(ISIT)
#Trích xu???t d??? li???u t??? tr???m 1
ISIT.Station1 <- ISIT[ISIT$Station == 1,]
head(ISIT.Station1)
#S??? quan sát t???i tr???m 1
nrow(ISIT.Station1)
# GTLN, GTNN, Giá tr??? trung b??nh, Giá tr??? trung v??? c???a ð??? sâu t???i tr???m 1
...
#Xác ð???nh s??? quan sát c???a các tr???m
tapply(ISIT$Sources, FUN = length, INDEX = ISIT$Station)
#Ta th???y tr???m 4 và tr???m 5 có s??? quan sát ít ðáng k??? so v???i ph???n c??n l???i. T???o khung d??? li???u m???i b??? qua các tr???m này. 
...
#BT3: Trong bý???c cu???i cùng c???a bài t???p trý???c, d??? li???u ðo ðý???c ??? ð??? sâu hõn 2000 mét vào tháng 4 ð?? ðý???c trích xu???t. Xu???t nh???ng d??? li???u này sang m???t t???p ascii m???i.
#BT4: Các tr???m t??? 1 ð???n 5 ðý???c l???y m???u vào tháng 4 nãm 2001, các tr???m t??? 6 ð???n 11 vào tháng 8 nãm 2001, các tr???m t??? 12 ð???n 15 vào tháng 3 nãm 2002 và các tr???m t??? 16 ð???n 19 vào tháng 10 nãm 2002. T???o hai bi???n m???i trong R ð??? xác ð???nh tháng và nãm. Th???c hi???n vi???c này b???ng cách thêm các bi???n m???i bên trong data frame.
#Bài t???p chýõng 4
